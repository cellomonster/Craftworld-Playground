  ...
  using cInt = Int32;
    ...
    public IntPoint(IntPoint pt)
    {
      this.X = pt.X; this.Y = pt.Y; this.Z = pt.Z;
		...
		public static implicit operator Vector2(IntPoint point)
		{
			return new Vector2(point.X / Global.ClipperPrecision, point.Y / Global.ClipperPrecision);
		}

		public static implicit operator Vector3(IntPoint point)
		{
			return new Vector3(point.X / Global.ClipperPrecision, point.Y / Global.ClipperPrecision);
		}

		public static implicit operator IntPoint(Vector2 vector)
		{
			return new IntPoint(vector.x * Global.ClipperPrecision, vector.y * Global.ClipperPrecision);
		}
	} // end struct IntPoint
