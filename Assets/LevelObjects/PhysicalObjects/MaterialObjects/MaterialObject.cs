...
namespace LevelObjects.PhysicalObjects.MaterialObjects
{
    ...
    public class MaterialObject : PhysicalObjectBase
    {
        ...
        private MaterialToolEntry materialToolEntry;
        
        public MaterialToolEntry Material
        {
            get => materialToolEntry;
            set
            {
                materialToolEntry = value;
        ...
        public void Setup(Paths shape, int frontLayer, int backLayer, MaterialToolEntry material)
        {
        ...
        public override void ApplyShapeModifications()
        {
            ...
            PolyCollider.density = materialToolEntry.Density * Thickness;
        }
